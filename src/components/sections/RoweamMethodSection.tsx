...
export const RoweamMethodSection = () => {
  return (
    <section className="max-container px-10 2xl:px-0 flex flex-wrap justify-center items-center mb-20">
      <div className="px-4 2xl:px-16 lg:w-[40%] my-6">
        <p className="uppercase font-sans text-secundary-light tracking-wide font-medium">
          Part new vintage, part true vintage
        </p>
        <h2 className="text-5xl md:text-6xl py-2 my-4 font-light opacity-80">
      ...
      <div className="overflow-hidden w-full sm:w-[90%] lg:w-[60%]">
        <img
          src={roweamMethodImg}
